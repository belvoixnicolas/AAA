<!DOCTYPE HTML>
  <html lang="fr">
    ...
    <body>
      ...
      <main>
        <section>
          <div class="coordoner wow animated fadeInDown">
          ...
          <div class="fomfram">
            <form action="#" method="post" class="wow animated fadeInLeft">
              <p>
